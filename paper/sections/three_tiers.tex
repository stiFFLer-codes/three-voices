...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{tier_clinician_boundary_mid.png}
\caption{The hero case rendered for the clinician: SHAP decomposition,
class probabilities, and the raw readings. The health worker's card and the
mother's lamp for the same prediction are rendered separately
(\texttt{tier\_asha\_boundary\_mid.png},
\texttt{tier\_mother\_boundary\_mid.png}); all four cases across all three
tiers are in the archived repository.}
\label{fig:tiers}
\end{figure}
